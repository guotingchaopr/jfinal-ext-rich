...
public class PoiKit {
	...
	public static HSSFWorkbook export(String sheetName, int cellWidth, int headerRow, String[] headers, String[] columns, List<?> list, int columnNum, boolean hasHeaders) {
